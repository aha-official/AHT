...
contract('AhaToken', async (accounts) => {
  ...
  describe('creation', () => {
    it("should put 15000000000 AhaToken in the first account", async () => {
      const balance = await ahaToken.balanceOf.call(accounts[0]);
      balance.should.be.bignumber.equal(totalBalance);
    });
  
    it('test correct settings of vanity information', async () => {
  ...
  describe('transfer', () => {
    ...
    it('should transfer 10000 to accounts[1] with accounts[0]', async () => {
      await ahaToken.transfer(accounts[1], 10000, { from: accounts[0] });
      const balance = await ahaToken.balanceOf.call(accounts[1]);
      assert.strictEqual(balance.toNumber(), 10000);
    });
  
    it('should fail when trying to transfer more balance than the balance accounts[0] having to accounts[1]', async () => {
  ...
  describe('approve', () => {
    ...
    it('allow accounts[1] 100 to withdraw from accounts[0]. Change allowance to 200 (should fail)', async () => {
      await ahaToken.approve(accounts[1], 100, { from: accounts[0] });
      const allowance01 = await ahaToken.allowance.call(accounts[0], accounts[1]);
      assert.strictEqual(allowance01.toNumber(), 100);
    ...
    it('allow accounts[1] 100 to withdraw from accounts[0]. Increase allowance to 200', async () => {
      await ahaToken.approve(accounts[1], 100, { from: accounts[0] });
      const allowance01 = await ahaToken.allowance.call(accounts[0], accounts[1]);
      assert.strictEqual(allowance01.toNumber(), 100);
    ...
    it('allow accounts[1] 100 to withdraw from accounts[0]. Change allowance to 50 (should fail)', async () => {
      await ahaToken.approve(accounts[1], 100, { from: accounts[0] });
      const allowance01 = await ahaToken.allowance.call(accounts[0], accounts[1]);
      assert.strictEqual(allowance01.toNumber(), 100);
    ...
    it('allow accounts[1] 100 to withdraw from accounts[0]. Decrease allowance to 50', async () => {
      await ahaToken.approve(accounts[1], 100, { from: accounts[0] });
      const allowance01 = await ahaToken.allowance.call(accounts[0], accounts[1]);
      assert.strictEqual(allowance01.toNumber(), 100);
  ...
  describe('burn', () => {
    it('burn 100 of accounts[0]', async () => {
    ...
    it('should fail when accounts[1] is trying to burn', async () => {
      await assertRevert(ahaToken.burn.call(100, { from: accounts[1] }));
    });
  
    it('add burner role to accounts[1]', async () => {
    ...
    it('renounce burner role of accounts[1]', async () => {
      await ahaToken.addBurner(accounts[1], { from: accounts[0] });
      const isBurner0 = await ahaToken.isBurner.call(accounts[1]);
      assert(isBurner0);
